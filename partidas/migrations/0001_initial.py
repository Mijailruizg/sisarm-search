    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField()),
                ('gravamen', models.DecimalField(decimal_places=2, max_digits=5)),
                ('permisos', models.TextField()),
                ('subpartidas', models.TextField()),
                ('referencia_legal', models.TextField()),
            ],
        ),
        migrations.CreateModel(
            name='Rol',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='partidas.rol')),
            ],
            options={
                'verbose_name': 'user',
